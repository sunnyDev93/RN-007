...
import { View, Text, Image, ViewPropTypes, Dimensions, Button, StyleSheet} from 'react-native';
...
console.log('TransformableImage, dimensions', screenHeight, screenWidth)
...
export default class TransformableImage extends PureComponent {
    ...
    render () {
        ...
        var isVideo = image.filetype && image.filetype.includes('video/');
         if(isVideo)
            console.log('TransformableImage', 'isVideo', image);
        const imageProps = {
            ...this.props,
            imageLoaded,
            source: image.source,
        ...
        const content = isVideo ? 
                ...
                <Video source={{uri: image.image.uri + ''}}   // Can be a URL or a local file.
                   ref={(ref) => {
                     this.player = ref
                   }}                                      // Store reference
                ...
                : imageComponent ? imageComponent(imageProps, imageDimensions) : <Image { ...imageProps } />;
        ...
        return (
            ...
            {
                !imageLoaded &&
                <View style = {{width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, alignItems: 'center', justifyContent: 'center', zIndex: 100, elevation: 10,}}>
