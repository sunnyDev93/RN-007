        ...
        if (!isError) {
            ...
            if (result != undefined && result != null) {
                if (result.data != undefined && result.data != null) {
                    ...
                    isProfile = true;
                    if (myProfileData.userProfileInfo.imgpath != undefined && myProfileData.userProfileInfo.imgpath != null) {
                        let userImagePath = myProfileData.userProfileInfo.imgpath;
                    ...
                    if (myProfileData.userProfileInfo.filename != undefined && myProfileData.userProfileInfo.filename != null) {
                        let userImageName = myProfileData.userProfileInfo.filename;
...
*/
               ...
               <Animatable.View
                ...
                >
                    ...
                    <Text style={[{fontSize: 18, color: Colors.white}, stylesGlobal.font_bold]}>
                        {myProfileData.userProfileInfo.first_name
                        + " " + myProfileData.userProfileInfo.last_name}
                    </Text>
                </Animatable.View>
            </View>
        );
    ...
    */
    ...
    renderUserInfo = () => {
        ...
        var heightView = null;
        if (myProfileData.userCustomFields.height != undefined && myProfileData.userCustomFields.height != null) {
        ...
        if (myProfileData.userProfileInfo.gold_coins != undefined && myProfileData.userProfileInfo.gold_coins != null) {
        ...
        var bodyView = null
        if (myProfileData.userCustomFields.body != undefined && myProfileData.userCustomFields.body != null) {
        ...
        if (myProfileData.connections != undefined && myProfileData.connections != null) {
        ...
        if (myProfileData.userCustomFields.net_worth != undefined && myProfileData.userCustomFields.net_worth != null) {
            var netWorth = myProfileData.userCustomFields.net_worth;
            netWorthView = (
                <View style={{flex: 1, flexDirection: "row", justifyContent: "center", alignItems: 'center'}}>
        ...
        let leftView = null;
        let rightView = null;
        if (myProfileData.userProfileInfo.type != undefined && myProfileData.userProfileInfo.type != null) {
            if (myProfileData.userProfileInfo.type.toUpperCase() == "MODEL") {
                leftView = heightView;
                rightView = bodyView;
            } else if (myProfileData.userProfileInfo.type.toUpperCase() == "RICH") {
    ...
    renderActionButtons = () => {
        ...
        var data = myProfileData.userProfileInfo;
        var imagePath = null;
                                        ...
                                        <ModalDropdown 
                                            ...
                                            renderButton = {() => {
                                                ...
                                                return (
                                                    ...
                                                    //     <Image style={{ width: '100%', height: '100%', position: 'absolute', borderRadius: 5 }} source={{ uri: this.state.user_role[this.state.rowInvitation[0].selected_user_role_index].background }}></Image>
                                                    ...
                                                    return (
                                                    <View style={[{ width: '100%', height: '100%', resizeMode: 'cover', alignItems: 'center', flexDirection: 'row', }]}>
                                                        <Image style={{ width: '100%', height: '100%', position: 'absolute', borderRadius: 2 }} source={{ uri: this.state.user_role[this.state.rowInvitation[0].selected_user_role_index].name }}></Image>
    ...
    */
    ...
    renderUserGallery = () => {
        ...
        var galleryImages = myProfileData.galleryImages;
    ...
    renderSuccessTimeLineView = () => {
        ...
        var dob = myProfileData.userProfileInfo.dob;
        ...
        return (
            ...
            {
                this.state.is_verified == "1" &&
                <TouchableOpacity style={[styles.emptyAddView, {position: 'absolute', right: 10, top: 5, backgroundColor: Colors.transparent}]}
                    onPress={() => {
                        this.props.navigation.navigate("AddSuccessTimeline", {
                            userId: this.state.userId,
                            userToken: this.state.userToken,
    ...
    renderTravelPlansView = () => {
        ...
        myProfileData.schedules.map((item, j) => {
            let endDate = new Date(Moment(item.to_date).format("YYYY-MM-DD"));
        ...
        return (
            <View style={[styles.viewContainerWithShadow, {maxHeight:450}]}>
            ...
            <View key={index} style={[styles.cardViewProfile]}>
                <View style={{ borderBottomWidth: 2, borderBottomColor: 'gray', paddingBottom: 10, paddingTop: 10 }}>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        ...
                        <Text style={[{ color: Colors.gold, marginLeft: 5, fontSize: 14, backgroundColor: Colors.transparent, }, stylesGlobal.font]}>{address}</Text>
                    </View>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', marginTop: 10, alignItems:'center' }}>
                        ...
                        <View style = { styles.dateView}>
                            <Text style = {[styles.date, stylesGlobal.font]}>{Moment(from_date).format("DD MMM YYYY")}</Text>
                        </View>
                        <Text style = {[styles.date, stylesGlobal.font, {marginLeft: 5}]}>{Moment(from_date).format("ddd")} </Text>
                        ...
                        <View style={styles.dateView}>
                            <Text style={[styles.date, stylesGlobal.font]}>{Moment(to_date).format("MMM DD, YYYY")}</Text>
                        </View>
                        <Text style = {[styles.date, stylesGlobal.font, {marginLeft: 5}]}>
                            {Moment(to_date).format("ddd")}
                        </Text>
                    </View>
