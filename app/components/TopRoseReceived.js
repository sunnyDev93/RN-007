...
var TAG = "TopRoseReceived";

export default class TopRoseReceived extends React.Component {
    ...
    getTopList() {
        try {
            ...
            var uri = Memory().env == "LIVE" ? Global.URL_TOPLIST_ROSERECEIVED : Global.URL_TOPLIST_ROSERECEIVED_DEV;
            ...
            <SafeAreaView style={styles.container}>
            {
                ...
                <View style = {{width: '100%', height: 100, justifyContent: 'center', alignItems: 'center',}}>
                    <View style = {{width: '93%', height: '93%', position: 'absolute', zIndex: 5}}>
                        <Image style = {{width: '100%', height: '100%', resizeMode: 'contain'}} source={require("../icons/toplist-roses-received.png")}/> 
                    </View>
                </View>
            {
                        ...
                        }
                        {
                            ...
                            <View style = {{width: '100%', marginBottom: 10, justifyContent: 'space-around', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 5}}>
                                <View style = {{height: 60, width: '100%', marginVertical: 15}}>
                                    <Image style = {{width: '100%', height: '100%', resizeMode: 'contain'}} source={require("../icons/toplist-sidepanel-heart.png")}/>
                                </View>
                                <Text style = {[styles.component_text, stylesGlobal.font, {marginBottom: 10}]}>{"Receive More Roses"}</Text>
                                <Text style = {[styles.component_text, stylesGlobal.font, {marginBottom: 10, fontSize: 12}]}>{"Find & Messages Friends"}</Text>
                                <TouchableOpacity style = {[stylesGlobal.common_button, stylesGlobal.shadow_style, {marginBottom: 15}]} onPress = {() => this.props.navigation.navigate('Dashboard', {selected_screen: "members"})}>
                                    <Text style = {[styles.component_text, stylesGlobal.font, {color: Colors.white}]}>Find Friends</Text>
                                </TouchableOpacity>
                            </View>
                        </ScrollView>
                    </View>
            ...
            <View style={[styles.person_view, index == -1 || item.id == this.state.userId ? {backgroundColor: Colors.gold} : null]} activeOpacity = {Global.activeOpacity} onPress = {() => this.gift_detail(item)}>
                ...
                <View style = {{width: '30%', height: '90%', justifyContent: 'center'}}>
                    ...
                    <View style = {styles.coin_view}>
                        <Image source={require('../icons/toplist-smallicons-rose.png')} style={{width: 30, height: 30, resizeMode:'contain'}} />
                        <View style = {{marginTop: 5}}>
                            <Text style = {[styles.component_text, stylesGlobal.font]}>{"Roses:"}</Text>
                            <Text style = {[styles.component_text, stylesGlobal.font]}>{item.rose_count ? item.rose_count : 0}</Text>
                        </View>
                    </View>
                </View>
            </View>
