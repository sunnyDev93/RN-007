...
var TAG = "MyListFavoriteMember";

export default class MyListFavoriteMember extends React.Component {
    ...
    getFavoriteList() {
        try {
            ...
            console.log(TAG + " callGetFavoriteAPI uri " + uri);
            console.log(TAG + " callGetFavoriteAPI params " + JSON.stringify(params));
            WebService.callServicePost(uri, params, this.handleGetFavorite);
        } catch (error) {
            console.log(TAG + " callGetFavoriteAPI error " + error);
            this.setState({
                loading: false,
            });
    ...
    handleGetFavorite = (response, isError) => {
        console.log(TAG + " callGetFavoriteAPI Response " + JSON.stringify(response));
        console.log(TAG + " callGetFavoriteAPI isError " + isError);
